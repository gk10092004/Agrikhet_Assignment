...
export default function CheckoutPage() {
  ...
  if (cart.length === 0)
    return (
      <div className="container px-[2rem] mx-auto py-8">
        Your cart is empty.
      </div>
    );
  ...
  return (
    <div className="w-full h-full px-4 md:px-[6rem] py-[0.5rem] flex flex-col">
      <div
        className={`absolute top-0 right-0 mr-[1rem] w-fit text-center mt-[1rem] 
            ...
            <div className="flex  flex-col gap-4">
              <div className="flex  order-2 sm:order-1 flex-col gap-2">
                <div className="p-4 md:p-[1rem] rounded-lg bg-[#f3f3f3] flex flex-col gap-2">
                  <h1 className="text-lg md:text-[1.2rem] font-bold">
                    Delivery Address
                  </h1>
                  <div className="flex flex-col  gap-2">
                    <div className="flex flex-col  md:flex-row gap-2">
                      <div className="flex-1">
                        <h2 className="text-[#3a3a3a] text-sm">
              ...
              <div className="flex flex-col gap-4 h-[50vh] md:h-[70vh]">
                <ul className="overflow-auto scrollbar-hide space-y-4">
                  {cart.map((item) => (
                    <li
                      key={item.id}
                      className="flex items-center gap-2 md:gap-4 border-b py-4"
                    >
                      <Image
                        src={item.image}
                        alt={item.name}
                ...
                <div className="p-4 bg-gray-100 rounded space-y-2">
                  ...
                  {promovalid && (
                    <div className="flex justify-between ">
                      ...
                      <span>- ₹{Number((total - totalCost).toFixed(3))}</span>
                    </div>
                  )}
